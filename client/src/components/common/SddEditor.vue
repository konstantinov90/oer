...
export default {
  ...
  data() {
    ...
    return {
      ...
      selectedDateEnd,
      possibleSections: {
        'ARM-BEL': ['RUS-ARM', 'RUS-BEL'],
        'ARM-RUS': ['RUS-ARM'],
        'ARM-KAZ': ['RUS-ARM', 'RUS-KAZ'],
        'ARM-KGZ': ['RUS-ARM', 'RUS-KAZ', 'KAZ-KGZ'],
        'BEL-ARM': ['RUS-BEL', 'RUS-ARM'],
        'BEL-RUS': ['RUS-BEL'],
        'BEL-KAZ': ['RUS-BEL', 'RUS-KAZ'],
        'BEL-KGZ': ['RUS-BEL', 'RUS-KAZ', 'KAZ-KGZ'],
        'RUS-ARM': ['RUS-ARM'],
        'RUS-BEL': ['RUS-BEL'],
        'RUS-KAZ': ['RUS-KAZ'],
        'RUS-KGZ': ['RUS-KAZ', 'KAZ-KGZ'],
        'KAZ-ARM': ['RUS-KAZ', 'RUS-ARM'],
        'KAZ-BEL': ['RUS-KAZ', 'RUS-BEL'],
        'KAZ-RUS': ['RUS-KAZ'],
        'KAZ-KGZ': ['KAZ-KGZ'],
        'KGZ-ARM': ['KAZ-KGZ', 'RUS-KAZ', 'RUS-ARM'],
        'KGZ-BEL': ['KAZ-KGZ', 'RUS-KAZ', 'RUS-BEL'],
